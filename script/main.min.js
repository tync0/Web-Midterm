...
const menuBtn = document.querySelector(".butger-btn")
  ...
  , toggleMenu = ()=>{
    ...
    menuWrap.classList.contains("menu-active") ? (menuBtn.setAttribute("aria-laberl", "close menu"),
    menuBtn.setAttribute("aria-expanded", "true")) : (menuBtn.setAttribute("aria-laberl", "open menu"),
